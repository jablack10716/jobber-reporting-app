...
ActiveRecord::Schema.define(version: 2024_09_10_120000) do
  ...
  create_table "reports", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["jobber_account_id"], name: "index_reports_on_jobber_account_id"
  end

  add_foreign_key "reports", "jobber_accounts"
end

# -*- encoding: utf-8 -*-
# stub: graphql-client 0.26.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<graphql>.freeze, [">= 1.13.0"])
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.75.8"])
  else
    s.add_dependency(%q<activesupport>.freeze, [">= 3.0"])
    s.add_dependency(%q<graphql>.freeze, [">= 1.13.0"])
    ...
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.75.8"])
  end
end

...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<google-protobuf>.freeze, [">= 0"])
    s.add_development_dependency(%q<graphql-batch>.freeze, [">= 0"])
    ...
    s.add_development_dependency(%q<jekyll-sass-converter>.freeze, ["~> 2.2"])
    ...
    s.add_dependency(%q<jekyll-sass-converter>.freeze, ["~> 2.2"])
